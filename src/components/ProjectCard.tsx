...
const ProjectCard = ({
  ...
  return (
    ...
    >
      <motion.div
        className='group bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl border border-gray-200/50 p-6 transition-all duration-300 hover:-translate-y-2 h-full'
        whileHover={{ scale: 1.02 }}
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
